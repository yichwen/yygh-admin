<template>
  <div class="app-container">
    <h4>基本信息</h4>
    <table v-if="hospital" class="table  table-striped  table-condenseda  table-bordered" width="100%">
      <tbody>
      <tr>
        <th width="15%">医院名称</th>
    ...
    <h4>预约规则信息</h4>
    <table v-if="bookingRule" class="table  table-striped  table-condenseda  table-bordered" width="100%">
      <tbody>
      <tr>
        <th width="15%">预约周期</th>
